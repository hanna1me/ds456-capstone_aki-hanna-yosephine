...
# Keep these for the substitution explorer, but we’ll downsample later
...
# ---- Distance to nearest stop (then downsample) ----
...
# Drop geometry + heavy size, keep sample per behaviour for boxplot
set.seed(123)
...
# ---- Tract-level stats & priority scores ----
start_points_cent <- st_centroid(start_points_beh)

# point-within-tract join is cheaper than tract-within-points
...
# Priority scores (equity-focused gap)
